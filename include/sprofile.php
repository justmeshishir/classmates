	...
	<div class="profile">
        ...
        <div class="nav">
         <ul>
            ...
            <li><a href="sprofile.php">Home</a></li>
		...
		?>
            ...
            <div class="remember">
            <form action="remember_action.php" method="post">
                <input type="hidden" name="hidden" id="hidden"  value="<?php echo $id; ?>" />
               <input type="submit" name="remember" id="remember" class="remember_button" value="Remember" />
            </form>
            </div>
         <?php 
				}
